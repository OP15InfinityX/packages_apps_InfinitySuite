...
import com.infinity.suite.fragments.SensorBlock;
import com.infinity.suite.fragments.AdaptivePlayback;
...
public class MiscSettings extends SettingsPreferenceFragment implements
    ...
    public static void reset(Context mContext) {
        ...
        Settings.Secure.putIntForUser(resolver,
                Settings.Secure.SHOW_CLIPBOARD_OVERLAY, 1, UserHandle.USER_CURRENT);
