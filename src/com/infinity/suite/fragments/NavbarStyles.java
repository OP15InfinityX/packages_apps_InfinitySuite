...
public class NavbarStyles extends SettingsPreferenceFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.nav_icon_view_horizontal, container, false);
    ...
    private void updatePreview(RecyclerView recyclerView) {
        ...
        if (centerView != null) {
            ...
            if (centerPosition >= 0 && centerPosition < mPkgs.size()) {
                ...
                previewImage1.setImageDrawable(getDrawable(getActivity(), pkg, "ic_sysbar_back"));
                previewImage2.setImageDrawable(getDrawable(getActivity(), pkg, "ic_sysbar_home"));
                previewImage3.setImageDrawable(getDrawable(getActivity(), pkg, "ic_sysbar_recent"));
                mSelectedPkg = pkg;
    ...
    public class Adapter extends RecyclerView.Adapter<Adapter.CustomViewHolder> {
        ...
        public void onBindViewHolder(CustomViewHolder holder, final int position) {
            ...
            holder.name.setText("com.android.launcher3".equals(pkg) ? "Default" : getLabel(holder.name.getContext(), pkg));
