...
class PlayIntegrityFix : SettingsPreferenceFragment() {
    ...
    private fun setupPifEnableToggle() {
        val pref = findPreference<SwitchPreferenceCompat>(PIF_ENABLE_PREF_KEY) ?: return
        val resolver = requireContext().contentResolver
        val stored = Settings.Secure.getStringForUser(
            resolver,
            PIF_ENABLED_KEY,
            UserHandle.USER_CURRENT
        )
        val enabled = if (stored == null) {
            val defaultEnabled = !SystemProperties.get("ro.soc.manufacturer").equals("Google", ignoreCase = true)
            ...
            stored == "1" || stored.equals("true", ignoreCase = true)
        }
    ...
    private fun populateConfigDetails(data: Map<String, String>) {
        ...
        category.setTitle(R.string.pif_config_details)
    ...
    companion object {
        ...
        private const val PIF_ENABLE_PREF_KEY = "pif_enable_fix"
